...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      { url: "/api/branding/assets/logo-field?home=1&v=tab1", sizes: "512x512", type: "image/png" },
    ],
    apple: [{ url: "/api/branding/assets/logo-field?apple=1&v=tab1", sizes: "180x180", type: "image/png" }],
  },
};
