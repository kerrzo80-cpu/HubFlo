...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      { url: "/api/branding/assets/logo-heat-design?home=1&v=compose5", sizes: "512x512", type: "image/png" },
    ],
    apple: [{ url: "/api/branding/assets/logo-heat-design?apple=1&v=compose5", sizes: "180x180", type: "image/png" }],
  },
};
