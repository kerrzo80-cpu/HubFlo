...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    deployment: {
      ...
      simproImportQuality: "quote-site-html-busybar-v1",
      simproCustomerNames: "fetch-by-customer-id-v2-throttled",
      ...
      simproImportScope: "open-quotes-40-jobs-40-30-unpaid-deep-20-v1",
