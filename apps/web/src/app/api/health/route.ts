...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    deployment: {
      ...
      simproImportScope: "clients-sites-80-quotes-30-jobs-80-deep-80-v6",
      ...
      uiSchedulerAvailability: "card-ticks-only-v1",
      uiOverviewGantt: "same-as-scheduler-people-v1",
      ...
      jobFoldersPassaround: "complete-then-ready-v1",
