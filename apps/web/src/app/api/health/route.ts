...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    deployment: {
      ...
      simproImportQuality: "quote-no-wrong-customer-stamp-v1",
      ...
      simproImportScope: "clients-sites-80-quotes-12-deep-12-timeout-safe-v4",
      ...
      quoteWrongCustomerFix: "no-list-fallback-row-v2",
      quoteCostPriceDistinct: "no-sell-as-cost-v1",
