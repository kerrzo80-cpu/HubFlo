...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    deployment: {
      ...
      simproImportQuality: "sites-cap-customer-site-cc-v1",
      simproCustomerNames: "bare-id-hydrate-v3",
      ...
      simproImportScope: "clients-sites-80-quotes-40-deep-40-skip-existing-cc-v1",
