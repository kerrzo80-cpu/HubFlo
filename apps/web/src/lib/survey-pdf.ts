...
export async function createSurveyPdf(
  ...
  pdf.setAuthor("Errol Watson Group Ltd - Blake Surveyor");
  ...
  pages.forEach((pdfPage, index) => {
    ...
    pdfPage.drawText("Errol Watson Group Ltd | Generated by Blake Surveyor", { x: margin, y: 22, font: regular, size: 7, color: muted });
